 ...
 * 
 * @see <a href="https://docs.oracle.com/javase/specs/jvms/se17/html/jvms-4.html">The JVM class File
 *      Format Spec</a>
 */
public interface TargetInfo {
    /**
     * An item indicating that an annotation appears on the i'th type in an exception parameter
     * declaration.
     */
    ...
    /**
     * An item indicating that an annotation appears on either the type in a field declaration, the
     * type in a record component declaration, the return type of a method, the type of a newly
    ...
    /**
     * An item indicating that an annotation appears on the type in a formal parameter declaration
    ...
    class FormalParameterTarget implements TargetInfo {
        ...
        /**
         * @return An index indicating which formal parameter declaration has an annotated type. The
         *         index starts at 0.
         */
        ...
        /**
         * @return All formal parameter target annotations from a {@link TypeAnnotation} list at a
         *         specified index.
         */
        public static List<TypeAnnotation> extract(List<TypeAnnotation> typeAnnotations, int formalParameterIndex) {
            return typeAnnotations.stream().filter(typeAnnotation -> {
                ...
                return targetInfo instanceof FormalParameterTarget && ((FormalParameterTarget) targetInfo)
                        .getFormalParameterIndex() == formalParameterIndex;
            }).collect(Collectors.toList());
        }
    }

    /**
     * An item indicating that an annotation appears on the type in a local variable declaration,
    ...
    class LocalvarTarget implements TargetInfo {
        ...
        public static class Offsets {
            ...
            /**
             * @return The given local variable must be at index in the local variable array of the
             *         current frame.
             */
            public int getIndex() {
                return index;
    ...
    /**
     * Item that indicates that an annotation appears on either the type in an instanceof expression
    ...
    class OffsetTarget implements TargetInfo {
        ...
        /**
         * @return The offset item, specifying the code array offset of either the bytecode
    ...
    /**
     * Item that indicates that an annotation appears on a type in the extends or implements clause
     * of a class or interface declaration. The index starts at 0.
     */
    class SupertypeTarget implements TargetInfo {
        ...
        /**
         * @return An index into the interfaces array of the enclosing ClassFile structure, which
         *         specifies that the annotation appears on that superinterface in either the
         *         implements clause of a class declaration or the extends clause of an interface
         *         declaration. A value of 65535 specifies that the annotation appears on the
        ...
        /**
         * @return All super types annotations from a {@link TypeAnnotation} list at a specified
         *         super type index.
         */
    ...
    /**
     * An item indicating that an annotation appears on the i'th type in the throws clause of a
    ...
    class ThrowsTarget implements TargetInfo {
        ...
        /**
         * @return An index into the exception table array of the exceptions attribute of the method
         *         info structure. The index starts at 0.
         */
        ...
        /**
         * @return All throws clause type annotations from a {@link TypeAnnotation} list at a
         *         specified throws type index.
         */
    ...
    /**
     * Item that indicates that an annotation appears on the declaration of the i'th type parameter
    ...
    class TypeParameterTarget implements TargetInfo {
        ...
        /**
         * @return All type parameter type annotations from a {@link TypeAnnotation} list at a
        ...
        public static List<TypeAnnotation> extract(List<TypeAnnotation> typeAnnotations, int typeParameterIndex) {
            return typeAnnotations.stream().filter(typeAnnotation -> {
                TargetInfo targetInfo = typeAnnotation.getTargetInfo();
                return targetInfo instanceof TypeParameterTarget && ((TypeParameterTarget) targetInfo)
                        .getTypeParameterIndex() == typeParameterIndex;
            }).collect(Collectors.toList());
        }
    }

    /**
     * Item that indicates that an annotation appears on the i'th bound of the j'th type parameter
    ...
    class TypeParameterBoundTarget implements TargetInfo {
        ...
        /**
         * @return an index indicating which type parameter declaration has an annotated bound. The
         *         index starts at 0.
         */
        public int getTypeParameterIndex() {
            return typeParameterIndex;
        ...
        /**
         * @return an index indicating which bound of the type parameter declaration indicated by
         *         getTypeParameterIndex is annotated.
         */
        ...
        /**
         * @return All type parameter type annotations from a {@link TypeAnnotation} list at a
         *         specified parameter and bound index.
         */
        public static List<TypeAnnotation> extract(List<TypeAnnotation> typeAnnotations, int typeParameterIndex, int boundIndex) {
            return typeAnnotations.stream().filter(typeAnnotation -> {
                TargetInfo targetInfo = typeAnnotation.getTargetInfo();
                return targetInfo instanceof TypeParameterBoundTarget && ((TypeParameterBoundTarget) targetInfo)
                        .getTypeParameterIndex() == typeParameterIndex && ((TypeParameterBoundTarget) targetInfo)
                                .getBoundIndex() == boundIndex;
            }).collect(Collectors.toList());
        }
    }
