...
public class StructTypePathEntry {
    ...
    /**
     * @return The type argument index, indicating which nested type argument is annotated. The
     *         index starts at 0.
     */
    ...
    public enum Kind {
        ...
        /**
         * Type path entry is a nested type contained in e.g.
         * <code> Outer . @B Middle . @C Inner</code>
         */
        NESTED(1),

        /**
         * Type path entry is a wildcard contained in e.g.
         * <code>Map<@B ? extends String, String></code>
         */
        TYPE_WILDCARD(2),

        /**
         * Type path entry is a type argument of a parameterized type contained in e.g.
         * <code>List<@B Comparable<@F Object>></code>
         */
        TYPE(3);
