 ...
 */
package reincarnation.coder.ts;
...
public class TypeScriptCoder extends Coder<TypeScriptCodingOption> {
    ...
    private void writeFieldDefinition(Field field) {
        ...
        line(modifier(field, false), space, field.getName(), space, ":", space, name(field.getType()), ";");
    }
    ...
    public void writeConstructor(Constructor con, Code<Code> code) {
        ...
        line("constructor", buildParameter(con, naming(code)), space, "{");
        indent(() -> {
    ...
    public void writeMethod(Method method, Code<Code> code) {
        ...
        lineNB(modifier(method, method.isDefault()), name(method.getTypeParameters()), " ", method
                .getName(), buildParameter(method, naming(code)), " : ", name(method.getGenericReturnType()));
